...
export const GET: APIRoute = async ({ url }) => {
    ...
    const bgGradient = theme === 'light'
        ? 'radial-gradient(circle at 50% 40%, #f1f5f9 0%, #e2e8f0 100%)'
                    ...
                    // Badge — top-left, below story chrome (y: 140px)
                    {
                        ...
                        props: {
                            ...
                            children: [{
                                type: 'div',
                                props: {
                                    style: { fontSize: '22px', fontWeight: 800, color: gold, letterSpacing: '0.1em', textTransform: 'uppercase' },
                                    children: dealLabel,
                                },
                            }],
                        },
                            ...
                            children: [
                                ...
                                // Price — the visual hero
                                {
                                    ...
                                    props: {
                                        ...
                                        children: [
                                            { type: 'div', props: { style: { fontSize: '180px', fontWeight: 900, color: gold, lineHeight: 0.9 }, children: displayValue } },
                                ...
                                // Domain — branding, above the link sticker safe zone
                                {
                                    type: 'div',
                                    props: {
                                        style: { fontSize: '24px', fontWeight: 600, color: gold, opacity: 0.7, marginTop: '20px' },
